...
export const RouteSelect = () => {
  ...
  return (
    <div className="space-y-1">
      ...
      <Route Icon={FiUsers} selected={false} title="Manage Account" onClick={() => router.push('/ManageAccount')} />
      <Route Icon={FiGift} selected={false} title="Voucher" onClick={() => router.push('/Voucher')} />
      <Route Icon={FiPaperclip} selected={true} title="Advertisement" onClick={() => router.push('/Advertisement')} />
